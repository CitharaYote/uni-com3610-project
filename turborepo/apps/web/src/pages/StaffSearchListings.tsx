        ...
        <div className="flex flex-col items-center col-span-4 px-4 py-8 transition-shadow bg-white shadow-lg gap-y-4 rounded-2xl hover:shadow-xl text-uos-gray">
          ...
          >
            ...
            {isSuccessJobPostingsSearch &&
              ...
              jobPostingsSearch.jobPostings.map((jobPosting: ListingType) => {
                return (
                  <button
                  ...
                  >
                    <div className="flex flex-row items-center justify-between w-full">
                      ...
                      <div className="flex flex-row items-center w-60 gap-x-4">
                        ...
                        <div className="flex flex-col w-24 text-sm">
                          <p className="text-xs">
                            {new Date(jobPosting.dates.closingDate) > new Date()
                              ? "Closing"
                              : "Closed"}
                          </p>
                          <p className="text-ellipsis">
...
export default StaffSearchListings;
