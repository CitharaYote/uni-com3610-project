...
import { useGetAllSavedQuery } from "../redux/profile/profileApiSlice";
...
const SavedListings = () => {
  ...
  const handleSearch = async () => {
    console.log("RUNNING SEARCH WOOO");
  ...
  return (
    <PageSkeleton heading="Saved Listings">
      <div className="grid w-full h-full max-w-6xl grid-cols-4 gap-8 mt-8">
        <div className="flex flex-col items-center col-span-4 px-4 py-8 transition-shadow bg-white shadow-lg gap-y-4 rounded-2xl hover:shadow-xl text-uos-gray">
          <div className="flex flex-row items-center justify-center w-full mb-8 gap-x-4">
            <p className="text-3xl font-light ">Saved Listings</p>
            <svg
          ...
          <div
            className={`w-full px-8 pb-8 overflow-y-auto transition-transform max-h-[48rem]`}
          >
                ...
                <div className="flex flex-col items-center w-full">
                  <p className="mt-4 text-sm font-light text-uos-gray">
                    {jobPostingsSearch.jobPostings.length === 0
                      ? "No saved jobs found!"
                      : `Displaying ${jobPostingsSearch.jobPostings.length} of ${
